	...
	<div class="card-body">
		<div class="row">
			<div class="col-12 col-sm-6">
				...
				<div class="col-12">
					<img src="{{url('storage/'.$data->image) }}"  class="product-image" alt="Product Image">
				</div>
			</div>
			<div class="col-12 col-sm-6">
				...
				<div class="bg-gray py-2 px-3 mt-4">
					...
					<h4 class="mt-0">
						<small>Rp. {{$data->price}}</small><br>
						<small>Promo: Rp. {{$data->promo}}</small>
					</h4>
				</div>
		...
		<div class="row mt-4">
			...
			<div class="tab-content p-3" id="nav-tabContent">
				<div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"> 	<p>{{$data->deskripsi}}</p> </div>
